...
$budgetOptions = [
    ...
    'acima_20_mil' => 'Acima de R$ 20 mil',
    'a_definir' => 'Ainda estou definindo',
];
...
$investmentBudget = clean_text($_POST['investment_budget'] ?? '');
$currentPain = clean_text($_POST['current_pain'] ?? '');
...
if (!array_key_exists($investmentBudget, $budgetOptions)) {
    redirect_with_status($errorRedirect);
}
...
$messageLines = [
    'Novo briefing de projeto enviado pelo site JV Digital',
    '',
